...
public class programa {
	...
	public static void inicio() {
		...
		int cre_edad=0;
		while(!completado)	{
			System.out.println("\nCuantos años tienes "+cre_nombre+"?");	
			System.out.println("==========================");
			...
			System.out.println("\nAsi que tienes "+cre_edad+" años, es eso cierto?");
		...
		if (personaje1.getEdad()==40)	{
			System.out.println("Trabajas como herrero, al igual que tu padre, no es un trabajo muy lucrativo\nsobre todo después de que la guerra terminó, afortunadamente tienes los pedidos\njustos para poder vivir de ello. De camino del carbonero te encuentras con un soldado enfrentándose a un monstruo, \nparece que tiene problemas, asi que no te lo piensas 2 veces y te lanzas a dentro de la casa.");
		}
	}
